...
//     return ''; // Return empty string or handle error case gracefully
//   }
...
//     return (value / 1e3).toFixed(1) + "K FRW"; // Convert to thousands
//   } else {
//     return value.toFixed(0) + " FRW"; // No conversion needed
//   }
// };
...
//   // Extract building names and asset values
//   const categories = buildingData.map((building) => `${building.name} (${formatValue(building.totalAssetValue)})`);
//   const assets = buildingData.map((building) => building.totalAssetValue);

//   // Calculate dynamic height based on number of buildings
//   const minHeight = 130;
//   const maxHeight = 700; // Adjust maximum height as per your design requirements
//   const dynamicHeight = Math.min(Math.max(buildingData.length * 50, minHeight), maxHeight);
...
//       categories: categories,
//       labels: {
//         formatter: (val: string) => val, // Ensure labels are formatted correctly
//       },
//       axisTicks: {
//         show: false,
//       },
